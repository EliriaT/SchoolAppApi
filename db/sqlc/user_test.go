...
func CreateRandomUser(t *testing.T) User {
	...
	arg := CreateUserParams{
		...
		BirthDate: sql.NullTime{
			Time: seed.RandomBirthDate(), Valid: true,
		},
	}
	...
	require.WithinDuration(t, arg.BirthDate.Time, user.BirthDate.Time, time.Hour*24)
...
func TestGetUser(t *testing.T) {
	...
	require.WithinDuration(t, user1.BirthDate.Time, user2.BirthDate.Time, time.Second)
